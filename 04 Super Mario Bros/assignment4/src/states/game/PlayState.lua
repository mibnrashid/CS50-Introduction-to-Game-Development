...
function PlayState:enter(params)
    ...
    self.player.level2 = params.level2
    print(self.player.score)
    print(self.player.level2)
...
function PlayState:render()
    ...
    love.graphics.print(tostring(self.player.level2), VIRTUAL_WIDTH - 16, 4)
    love.graphics.print(tostring(self.width), VIRTUAL_WIDTH / 2 - 10, 4)
end
