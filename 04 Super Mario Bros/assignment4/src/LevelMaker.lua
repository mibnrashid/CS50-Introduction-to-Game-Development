    ...
    for x = 1, width do
        ...
        if x == 1 then
            ...
            if math.random(7) == 1 and x <= width - 5 then
                ...
                elseif math.random(20) == 1 or x == width / 2 then
                    if key == false then
                        -- key
                        local lockkey = GameObject {
                            ...
                            onConsume = function(player, object)
                                ...
                                gSounds['powerup-reveal']:play()
                                lock = false
                                lockbrick.consumable = true
                            end
                        } 
                            
                        Timer.tween(0.1, {
                            [lockkey] = {y = (blockHeight - 2) * TILE_SIZE}
                        })

                        table.insert(objects, lockkey)
