...
function Level:update(dt)
    ...
    if self.launchMarker.launched and self.launchMarker.more == false then
    ...
    elseif self.launchMarker.launched and self.launchMarker.more == true then
        local xPos, yPos = self.launchMarker.alien.body:getPosition()
        local xVel, yVel = self.launchMarker.alien.body:getLinearVelocity()
        ...
        local Vel1 = math.abs(xVel) + math.abs(yVel)
        local Vel2 = math.abs(xVel2) + math.abs(yVel2)
        local Vel3 = math.abs(xVel3) + math.abs(yVel3)

        if Vel1 <= 1.5 and Vel2 <= 1.5 and Vel3 <= 1.5 then
            self.launchMarker.alien.body:destroy()
        ...
        if xPos < 0 and xPos2 < 0 and xPos3 < 0 then
            self.launchMarker.alien.body:destroy()
            self.launchMarker.alien2.body:destroy()
            self.launchMarker.alien3.body:destroy()
            self.launchMarker = AlienLaunchMarker(self.world)
