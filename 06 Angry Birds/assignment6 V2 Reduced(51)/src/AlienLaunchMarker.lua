...
function AlienLaunchMarker:update(dt)
    ...
    elseif self.launched and love.keyboard.wasPressed('space') and self.hit == false and self.more == false then
        self.alien2 = Alien(self.world, 'round', self.alien.body:getX(), self.alien.body:getY() + 35, 'Player')
        ...
        self.alien3 = Alien(self.world, 'round', self.alien.body:getX(), self.alien.body:getY() - 35, 'Player')
        self.alien3.body:setLinearVelocity((self.baseX - self.shiftedX) * 10, (self.baseY - self.shiftedY) * 10)
