...
function PlayState:enter(params)
    ...
    self.ball2 = Ball2()
    self.ball2.dy = -100
    self.ball2.dx = math.random(-50, -60)

    self.powerup = Powerup()
    self.spawnPoints = 5000
...
function PlayState:update(dt)
    ...
    if self.score > self.spawnPoints and self.ball2.inPlay == false then
        self.powerup.inPlay = true
        self.spawnPoints = self.spawnPoints + 5000
    elseif self.score > self.spawnPoints then
        self.spawnPoints = self.spawnPoints + 5000
    end
